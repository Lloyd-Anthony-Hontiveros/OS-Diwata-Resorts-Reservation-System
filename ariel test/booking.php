								...
								<div class="billing-form">
									<form action="" method='post'>
										<div class="row">
											...
											<div class="col-md-12">
												<label>
													<h3>Card Type</h3>
													<select name='brand'>
														<option selected="selected" disabled="disabled">Card Brand
														</option>
											...
											<div class="col-md-6">
												<label>
													...
													<select name='exp_month'>
														<option selected="selected" disabled="disabled">Expiry Month:
														</option>
											...
											<div class="col-md-6">
												<label>
													...
													<select name='exp_year'>
														<option selected="selected" disabled="disabled">Expiry year:
														</option>
										...
										<div class="total-bill">
											...
											<button type="submit" name="submit" class="total-bill" value="Submit"
									...
									<div class="cr-account">
										...
										<div class="make-acnt">
											...
											<p>Make your payment directly into our bank account. Place use your order ID
												as thepayment reference. Your order won’t be shipped until the funds
										...
										<div class="make-acnt sco">
											...
											<ul>
												<li><a href="#" title=""><img
															src="http://creativethemes.us/relax/images/resources/bill1.png"></a>
												</li>
												<li><a href="#" title=""><img
															src="http://creativethemes.us/relax/images/resources/bill2.png"></a>
												</li>
												<li><a href="#" title=""><img
															src="http://creativethemes.us/relax/images/resources/bill3.png"></a>
												</li>
												<li><a href="#" title=""><img
															src="http://creativethemes.us/relax/images/resources/bill4.png"></a>
												</li>
												<li><a href="#" title=""><img
															src="http://creativethemes.us/relax/images/resources/bill5.png"></a>
												</li>
												<li><a href="#" title=""><img
															src="http://creativethemes.us/relax/images/resources/bill6.png"></a>
												</li>
											</ul>
										</div>
									</div><!--cr-account end-->
