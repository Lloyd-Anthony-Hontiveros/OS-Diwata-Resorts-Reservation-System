...
<head>
  ...
  <script src="dashboard_files/color-modes.js"></script>
  ...
  <link href="dashboard_files/bootstrap-icons.css" rel="stylesheet">
  <!-- Custom styles for this template -->
                ...
                <div class="col-8 m-auto">
                  ...
                  <div class="mb-3">
                    <span class="fw-bold">Total Price: </span><input type="text" class="form-control-plaintext fw-bold"
                      name="Total-Price" id="total-price" value="0" disabled>
                  </div>
                </div>
              </div>
            </div>
